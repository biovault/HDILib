...
If the HDILib was built with the "kompute" feature, additionally set define the CMake variables `VCPKG_MANIFEST_FEATURES` as `"kompute;example"` and `VCPKG_OVERLAY_PORTS` as `"PATH_TO/HDILib/vcpkg-overlays/kompute".
