...
if [ ${#TRAVIS_TAG} gt 0 ] then; export CONAN_REFERENCE=$1/${TRAVIS_TAG}@$2; exit 0; fi
if [[ $TRAVIS_BRANCH =~ $REGEX_MASTER ]]; export CONAN_REFERENCE=$1/latest@$2; exit 0; fi
if [[ $TRAVIS_BRANCH =~ $REGEX_FEATURE ]]; export CONAN_REFERENCE=$1/${BASH_REMATCH[1]}@$2; exit 0; fi
